...
module.exports = {
  ...
  AUTHOR: process.env.AUTHOR || "X-Factor",
  SUDO: process.env.SUDO || "6289505520763",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "",
  OWNER_NAME: process.env.OWNER_NAME || "Akuivan-13",
  BOT_NAME: process.env.BOT_NAME || "X-Factor",
